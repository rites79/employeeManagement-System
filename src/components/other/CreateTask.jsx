...
const submitHandler = (e) => {
  ...
  updatedData.forEach((elem) => {
    if (asignTo === elem.firstName) {
      elem.tasks = [...elem.tasks, newTask]  // ✅ immutable update
      elem.taskCount.newTask = elem.taskCount.newTask + 1
    }
  })

  setUserData(updatedData)   // ✅ trigger re-render
  ...
  return (
     <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
      <form onSubmit={(e)=>{
        ...
        className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent' type="text" placeholder='Make a UI design'/>
       </div> 
            <div>
